...
export class FirstMigration1749142088841 implements MigrationInterface {
  name = 'FirstMigration1749142088841';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`volunteers\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(50) NULL, \`last_name\` varchar(50) NULL, \`birth_date\` varchar(100) NULL, \`phone_number\` varchar(30) NOT NULL, \`email\` varchar(100) NULL, \`num_identification\` varchar(100) NULL, \`is_active\` tinyint NOT NULL DEFAULT 0, \`is_voluntary\` tinyint NOT NULL DEFAULT 1, \`cv_url\` varchar(255) NOT NULL, \`date_postulation\` date NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
